...
def main():
    choice = input("If you would like to reverse a word or phrase type 'reverse'. If you would like to capitalize a phrase or word type 'capitalize'.\n").lower()

    if choice == 'reverse':
        word = input("Please type what you would like to see reversed:\n")
        tu.reverse_string(word)

    elif choice == 'capitalize':
        word = input("Please type what you want to see capitalized:\n")
        tu.capitalize_string(word)
